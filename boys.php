...
$value=$_POST['block'];
$q2="CREATE TABLE IF NOT EXISTS boys(
...
$q3="INSERT INTO boys(student_name,fathers_name,fathers_occupation,mobile_no,email,branch,per_address,cur_address,country,hostel_block,block) VALUES ('$SName','$FName','$Foccupation','$MNo','$email','$branch','$Paddress','$taddress','$country','$block','$value')";
...
$conn->close();
 ...
 s
 <script>
  setTimeout(function(){location.href='boys.html'},5000);
  </script>
